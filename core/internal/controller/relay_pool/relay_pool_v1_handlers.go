...
var providerMeta = []v1.ProviderMeta{
	...
	{Type: "mailtrap", Label: "Mailtrap", DailyFree: 33, MonthlyFree: 1000, SignupURL: "https://mailtrap.io/register/signup", APIKeyLabel: "API Token", DocsURL: "https://api-docs.mailtrap.io/docs/mailtrap-api-docs/67f1d70aeb62c-send-email"},
}
